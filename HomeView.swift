...
struct HomeView_Previews: PreviewProvider {
    static var previews: some View {
        HomeView(showProfile: .constant(false), showContent: .constant(false), showtry: .constant(false))
    }
}
...
struct WatchRingsView: View {
    var body: some View {
        HStack(spacing: 30) {
            ...
            HStack(spacing: 12.0) {
                RingView(color1: #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1), color2: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), width: 32, height: 32, percent: 95, show: .constant(true))
                VStack(alignment: .leading, spacing: 4.0) {
                    Text("6 min").bold().modifier(FontModifier(style: .subheadline))
                    Text("Watc").modifier(FontModifier(style: .caption))
                }
                .modifier(FontModifier())
            }
            .padding(8)
