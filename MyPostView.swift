...
////  Future
////
////  Created by Will Janey on 6/2/20.
...
//                    .background(Color(Color("card2")))
//                .clipShape(RoundedRectangle(cornerRadius: 30, style: .continuous))
//                    .shadow(color: Color(Color("card3")).opacity(0.3), radius: 20, x: 0, y: 20)
//                .gesture(
//                    show ?
