...
//NEED TO BRING THIS BACK AFTER TESTING ⤵️
      ...
      //  let contentView = CreatePost()
       // let contentView = NotesFB()
        ...
        if let windowScene = scene as? UIWindowScene {
            ...
            //change to Observer to get tinder work USerStore for Future to work☢️
            //contentView.environmentObject(observer()))//🔥 tinder view works with firebase for login page
        }
    }
